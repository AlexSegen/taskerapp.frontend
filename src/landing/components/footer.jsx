    ...
    <footer className="bg-white text-gray-600 py-12 xl:pb-24">
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 flex flex-col md:flex-row justify-between items-center space-y-4 mt-8 lg:mt-12">
          <nav className="flex flex-wrap justify-center space-x-6"> 
            <a href="#" className=" text-sm hover:text-gray-700 mb-2">Privacy</a>
            <a href="#" className=" text-sm hover:text-gray-700 mb-2">Content Terms Notice</a>
            <a href="#" className=" text-sm hover:text-gray-700 mb-2">Legal</a>
            <a href="#" className=" text-sm hover:text-gray-700 mb-2">Features</a>
            <a href="#" className=" text-sm hover:text-gray-700 mb-2">Landing Pages</a>
          </nav>
