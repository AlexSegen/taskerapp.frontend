    ...
    <div className="bg-gradient-to-b from-gray-50 to-white lg:mb-16 xl:mb-24 py-12 lg:pt-20 relative overflow-hidden">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 relative z-20">
          ...
          <div className="mb-12 lg:mb-20">
            ...
            <li>
                <button className="py-3 lg:py-4 font-bold focus:outline-none hover:text-blue-700 w-full flex items-center justify-between">
                  <span className="flex-1 text-left pr-6">
                    What companies or products do you perceive as our competitors?
                  </span>
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </button>
              </li>
              <li>
                <button className="py-3 lg:py-4 font-bold focus:outline-none hover:text-blue-700 w-full flex items-center justify-between">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12  ">
            <Link to={HOME} className="bg-white rounded-lg shadow hover:shadow-xl transition-all duration-500 p-6 lg:p-8 border border-blue-100 flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6">
              ...
              <div className="flex-1">
                ...
                <span className="font-bold text-lg text-blue-600 flex items-baseline">
