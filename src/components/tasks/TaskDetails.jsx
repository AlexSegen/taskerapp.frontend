...
import { ClockOutlineIcon, CheckCircleIcon } from '../Icons'
    ...
    return ( 
        <div className="max-h-screen min-h-screen overflow-y-auto bg-white">
          ...
          <div className="w-full px-10 py-10" >
              ...
              <p className="flex items-center mb-10 text-gray-600"><ClockOutlineIcon className="inline w-5 mr-2 "/> {formatDate(task.createdAt)}</p>
